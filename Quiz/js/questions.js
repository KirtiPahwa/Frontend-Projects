let MCQS = [
  {
    ...
    choice1: " Open-source JavaScript back-end library",
    choice2: "JavaScript front-end library to create a database",
    choice3: "Free and open-source JavaScript front-end library",
